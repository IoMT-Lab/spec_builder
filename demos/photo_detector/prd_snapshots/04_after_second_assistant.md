...
- Runnable on-target binaries plus host test binaries.
- GitHub Actions workflow and scripts for flashing/running hardware tests.
- UART logs and JUnit XML reports published as CI artifacts.
